...
| Universe size | Top 200 stocks | `UNIVERSE_TOP_N` | `universe_filter.py` |
| Universe refresh cadence | Monthly | `UNIVERSE_REFRESH_CADENCE` | `universe_filter.py` |
...
| Per-leg sizing | 25% of portfolio | `INITIAL_LEG_SIZE_PCT` | `pyramiding_manager.py` |
